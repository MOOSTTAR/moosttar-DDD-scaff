...
public class UserOrderTest {
    ...
    public void test_selectByUserId() {
        List<UserOrderPO> list = userOrderDao.selectByUserId("moosttar_FOawiP");
    ...
    public void test_insert() {
        for (int i = 0; i < 10; i++) {
            UserOrderPO userOrderPO = UserOrderPO.builder()
                    .userName("moosttar")
                    .userId("moosttar_" + RandomStringUtils.randomAlphabetic(6))
    ...
    public void test_idx() {
        for (int i = 0; i < 50; i++) {
            String user_id = "moosttar_" + RandomStringUtils.randomAlphabetic(6);
